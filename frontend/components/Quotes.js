...
export default function Quotes() {
  const { data: quotes, isLoadin: gettingQuotes, isFetching: refreshingQuotes } = useGetQuotesQuery()
            ...
            .map(qt => (
              ...
              >
                ...
                <div className="quote-buttons">
                  ...
                  <button onClick={() => toggleFake({ id: qt.id, quotes: { apocryphal: !qt.apocryphal } })}>FAKE</button>
                </div>
              </div>
            ))
        }
